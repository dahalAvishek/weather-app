...
const TempContainer = forwardRef(function TempContainer({selectedData, selectedTime, datum, index, handleTimeChange}: Props, ref) {
    const checkCondition = (time: string) => {
      ...
      if (checkCondition(datum)) {
        return (
          <div
            className=
              "basis-40 grow flex-shrink-0 flex gap-2 flex-col cursor-pointer scale-105  "
              ref={ref}
